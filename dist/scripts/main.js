...
class L {
  static renderSidebarButtons() {
    ...
    if (o) {
      if (document.getElementById("hintz-manor-vertical-dock")?.remove(), document.getElementById("hintz-manor-dock")?.remove(), !document.getElementById("hm-tab-notebook")) {
        const e = document.createElement("a");
        e.id = "hm-tab-notebook", e.className = "item hintz-manor-sidebar-tab", e.setAttribute("data-tab", "hintz-notebook"), e.setAttribute("data-tooltip", "Detective Notebook"), e.setAttribute("aria-label", "Detective Notebook"), e.innerHTML = '<i class="fa-solid fa-book-skull"></i>', e.addEventListener("click", (t) => {
          t.preventDefault(), t.stopPropagation(), C || (C = new A()), C.render(!0);
        }), o.appendChild(e);
      }
      if (game.user.isGM && !document.getElementById("hm-tab-gm")) {
        const e = document.createElement("a");
        e.id = "hm-tab-gm", e.className = "item hintz-manor-sidebar-tab", e.setAttribute("data-tab", "hintz-gm-panel"), e.setAttribute("data-tooltip", "GM Mystery Control Center"), e.setAttribute("aria-label", "GM Mystery Control Center"), e.innerHTML = '<i class="fa-solid fa-masks-theater"></i>', e.addEventListener("click", (t) => {
          t.preventDefault(), t.stopPropagation(), k || (k = new S()), k.render(!0);
        }), o.appendChild(e);
      }
    }
  }
